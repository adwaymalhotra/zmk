...
from .constants import PRIOR_IDLE_MS, QUICK_TAP_MS, TAPPING_TERM, COMBO_TERM
from .behaviors.macro import Macro
        ...
        if all_combos:
            ...
            for c in all_combos:
                if isinstance(c, Combo):
                    resolved_c = c.resolve_with_keyboard(keyboard, layer_indices=layer_indices, total_contexts=total_contexts)
                else:
                    resolved_c = c
