...
from ..constants import SFT, ALT, CTL, GUI
...
def SL(key: str, mod: Any = SFT) -> BehaviorCall: return hrm_l(mod, key)
def CL(key: str, mod: Any = CTL) -> BehaviorCall: return hrm_l(mod, key)
def AL(key: str, mod: Any = ALT) -> BehaviorCall: return hrm_l(mod, key)
def ML(key: str, mod: Any = GUI) -> BehaviorCall: return hrm_l(mod, key)

def SR(key: str, mod: Any = SFT) -> BehaviorCall: return hrm_r(mod, key)
def CR(key: str, mod: Any = CTL) -> BehaviorCall: return hrm_r(mod, key)
def AR(key: str, mod: Any = ALT) -> BehaviorCall: return hrm_r(mod, key)
def MR(key: str, mod: Any = GUI) -> BehaviorCall: return hrm_r(mod, key)

def SYL(key: str, layer: Any = "sys") -> BehaviorCall: return hrl_l(layer, key)
def SYR(key: str, layer: Any = "sys") -> BehaviorCall: return hrl_r(layer, key)
